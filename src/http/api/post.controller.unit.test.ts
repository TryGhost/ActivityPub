...
// Mock the app module to avoid initializing the whole app
vi.mock('app', () => ({
    globalFedify: {
        createContext: vi.fn(),
    },
...
// Now we can import PostController after mocking
...
describe('PostController', () => {
    ...
    let postController: InstanceType<typeof PostController>;
    let postRepository: KnexPostRepository;
    let accountRepository: KnexAccountRepository;
    let replyChainView: ReplyChainView;
    ...
    beforeEach(async () => {
        ...
        accountRepository = {} as KnexAccountRepository;
        replyChainView = {} as ReplyChainView;
    ...
    describe('handleGetPost', () => {
        ...
        it('should return 404 when post is not found', async () => {
            ...
            postService.getByApId = vi
                .fn()
                .mockResolvedValue(error('not-a-post'));
