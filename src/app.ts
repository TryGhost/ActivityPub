...
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        const postController =
            container.resolve<PostController>('postController');
        return postController.handleGetReplies(ctx);
    }),
);
...
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        const accountController =
            container.resolve<AccountController>('accountController');
        return accountController.handleGetPosts(ctx);
    }),
);
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        const accountController =
            container.resolve<AccountController>('accountController');
        return accountController.handleGetLikedPosts(ctx);
    }),
);
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        const accountController =
            container.resolve<AccountController>('accountController');
        return accountController.handleGetFollows(ctx);
    }),
);
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        ...
        return feedController.handleGetFeed(ctx);
    }),
);
app.get(
    '/.ghost/activitypub/inbox',
    ...
    spanWrapper((ctx: AppContext) => {
        const feedController =
            container.resolve<FeedController>('feedController');
        return feedController.handleGetInbox(ctx);
    }),
);
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        const feedController =
            container.resolve<FeedController>('feedController');
        return feedController.handleGetNotesFeed(ctx);
    }),
);
app.get(
    ...
    spanWrapper((ctx: AppContext) => {
        const feedController =
            container.resolve<FeedController>('feedController');
        return feedController.handleGetReaderFeed(ctx);
    }),
);
app.get(
