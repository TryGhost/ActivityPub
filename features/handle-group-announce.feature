Feature: Handling activities announced by a Group
  ...
  Scenario: We receive a Create(Article) activity announced by a Group
  ...
  Scenario: We receive a Create(Article) activity with a tampered object announced by a Group
