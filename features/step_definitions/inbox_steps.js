...
Then('the article {string} is in our inbox', async function (articleName) {
...
Then('the article {string} is not in our inbox', async function (articleName) {
    const article = this.objects[articleName];
...
Then('the note {string} is not in our inbox', async function (noteName) {
